...
class TestWithVarvault:
    """
    threadgroup-lib works really well together with varvault since varvault essentially abstracts away input variables and return variables from functions,
    ...
    def test_with_varvault(self):
        vault = varvault.create_vault(Keyring, "vault", varvault_vault_filename_to=vault_file, varvault_filehandler_class=varvault.FileTypes.JSON)
        sleep = 0.5
