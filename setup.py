...
setup(
    ...
    version=VERSION,
    description="A package that sets up thread-groups to run methods concurrently that can run concurrently in a relatively simple and intuitive way.",
    long_description=README,
    long_description_content_type="text/markdown",
    url="https://github.com/data-ductus/threadgroup-lib",
    author="Calle Holst",
